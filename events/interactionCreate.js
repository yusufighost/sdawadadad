...
module.exports = {
    ...
    execute: async (interaction) => {
        ...
        const bakimmodu = new EmbedBuilder()
            ...
            .setDescription(`Herhangi bir sorunuz vs. varsa <@1135223269759393876>'e ulaşınız!`);

        if (db.fetch(`bakim`)) {
            if (interaction.user.id !== "1135223269759393876") { return interaction.reply({ embeds: [bakimmodu]}) }
        }
